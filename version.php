...
$plugin->version   = 2025102401;      // The current plugin version (YYYYMMDDXX). Incremented to trigger upgrade and refresh language caches.
$plugin->release   = '1.1';           // Human readable release name.
